...
I work at Anthropic, so I use [Claude Code](https://docs.anthropic.com/en/docs/claude-code) daily. But things have gotten noticeably faster recently—building Lifelogs was significantly easier than similar projects would have been even a month ago.
