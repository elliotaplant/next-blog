...
Claude and I built this whole thing in an afternoon, which is a fun bit of meta: using AI to build a tool that makes AI better at poetry. Claude wrote most of the code, and now Claude uses the tool to write better poems. The circle of life, or something.
